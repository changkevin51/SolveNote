...
class TranslationsHomeTitlesEn {
	...
	// Translations
	String get home => 'Recent notesdsdsdsd';
	String get browse => 'Browse';
	String get whiteboard => 'Whiteboard';
	String get settings => 'Settings';
}
...
class TranslationsSettingsPrefDescriptionsEn {
	...
	String get allowInsecureConnections => '(Not recommended) Allow SolveNote to connect to servers with self-signed/untrusted certificates';
	...
	String get geminiApiKey => 'AI is used to provide detailed step-by-step answers';
...
class TranslationsLoginEncLoginStepEn {
	...
	String get newToSaber => 'New to SolveNote? Just enter a new encryption password.';
...
class TranslationsProfile$faq$0i1$En {
	...
	String get a => 'Go to your server website and log in. Then go to Settings > Security > Change password. You\'ll need to log out and log back in to SolveNote after changing your password.';
}
...
class TranslationsLoginNcLoginStepLoginFlowEn {
	...
	// Translations
	String get pleaseAuthorize => 'Please authorize SolveNote to access your Nextcloud account';
