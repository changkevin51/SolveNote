...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsProfileEn profile =
      TranslationsProfileEn.internal(_root);
  late final TranslationsAppInfoEn appInfo =
      TranslationsAppInfoEn.internal(_root);
...
class TranslationsHomeEn {
  ...
  // Translations
  late final TranslationsHomeTabsEn tabs =
      TranslationsHomeTabsEn.internal(_root);
  late final TranslationsHomeTitlesEn titles =
      TranslationsHomeTitlesEn.internal(_root);
  late final TranslationsHomeTooltipsEn tooltips =
  ...
  late final TranslationsHomeNewFolderEn newFolder =
      TranslationsHomeNewFolderEn.internal(_root);
  late final TranslationsHomeRenameNoteEn renameNote =
      TranslationsHomeRenameNoteEn.internal(_root);
  late final TranslationsHomeMoveNoteEn moveNote =
      TranslationsHomeMoveNoteEn.internal(_root);
  String get deleteNote => 'Delete note';
  late final TranslationsHomeRenameFolderEn renameFolder =
...
class TranslationsSettingsEn {
  ...
  // Translations
  late final TranslationsSettingsPrefCategoriesEn prefCategories =
      TranslationsSettingsPrefCategoriesEn.internal(_root);
  late final TranslationsSettingsPrefLabelsEn prefLabels =
      TranslationsSettingsPrefLabelsEn.internal(_root);
  late final TranslationsSettingsPrefDescriptionsEn prefDescriptions =
      TranslationsSettingsPrefDescriptionsEn.internal(_root);
  late final TranslationsSettingsThemeModesEn themeModes =
...
class TranslationsLoginEn {
  ...
  late final TranslationsLoginFormEn form =
      TranslationsLoginFormEn.internal(_root);
  TextSpan signup({required InlineSpanBuilder linkToSignup}) =>
      TextSpan(children: [
        const TextSpan(text: 'Don\'t have an account yet? '),
        linkToSignup('Sign up now'),
        const TextSpan(text: '!'),
      ]);
  TextSpan notYou({required InlineSpanBuilder undoLogin}) =>
      TextSpan(children: [
        const TextSpan(text: 'Not you? '),
        undoLogin('Choose another account'),
        const TextSpan(text: '.'),
      ]);
  late final TranslationsLoginStatusEn status =
      TranslationsLoginStatusEn.internal(_root);
  late final TranslationsLoginNcLoginStepEn ncLoginStep =
      TranslationsLoginNcLoginStepEn.internal(_root);
  late final TranslationsLoginEncLoginStepEn encLoginStep =
      TranslationsLoginEncLoginStepEn.internal(_root);
}
...
class TranslationsProfileEn {
  ...
  late final TranslationsProfileQuickLinksEn quickLinks =
      TranslationsProfileQuickLinksEn.internal(_root);
...
class TranslationsEditorEn {
  ...
  // Translations
  late final TranslationsEditorToolbarEn toolbar =
      TranslationsEditorToolbarEn.internal(_root);
  late final TranslationsEditorPensEn pens =
      TranslationsEditorPensEn.internal(_root);
  late final TranslationsEditorPenOptionsEn penOptions =
      TranslationsEditorPenOptionsEn.internal(_root);
  late final TranslationsEditorColorsEn colors =
      TranslationsEditorColorsEn.internal(_root);
  late final TranslationsEditorImageOptionsEn imageOptions =
      TranslationsEditorImageOptionsEn.internal(_root);
  late final TranslationsEditorSelectionBarEn selectionBar =
      TranslationsEditorSelectionBarEn.internal(_root);
  late final TranslationsEditorMenuEn menu =
      TranslationsEditorMenuEn.internal(_root);
  late final TranslationsEditorNewerFileFormatEn newerFileFormat =
      TranslationsEditorNewerFileFormatEn.internal(_root);
  late final TranslationsEditorQuillEn quill =
      TranslationsEditorQuillEn.internal(_root);
  late final TranslationsEditorHudEn hud =
      TranslationsEditorHudEn.internal(_root);
...
class TranslationsSettingsPrefDescriptionsEn {
  ...
  late final TranslationsSettingsPrefDescriptionsHideFingerDrawingEn
      hideFingerDrawing =
      TranslationsSettingsPrefDescriptionsHideFingerDrawingEn.internal(_root);
  ...
  String get geminiApiKey =>
      'AI is used to provide detailed step-by-step answers';
  late final TranslationsSettingsPrefDescriptionsPencilSoundSettingEn
      pencilSoundSetting =
      TranslationsSettingsPrefDescriptionsPencilSoundSettingEn.internal(_root);
}
...
class TranslationsLoginFormEn {
  ...
  // Translations
  TextSpan agreeToPrivacyPolicy(
          {required InlineSpanBuilder linkToPrivacyPolicy}) =>
      TextSpan(children: [
...
class TranslationsProfile$faq$0i0$En {
  ...
  String get a =>
      'No. Your notes will remain both on your device and on the server. They won\'t be synced with the server until you log back in. Make sure syncing is complete before logging out so you don\'t lose any data (see the sync progress on the home screen).';
}
...
class TranslationsEditorMenuEn {
  ...
  late final TranslationsEditorMenuBoxFitsEn boxFits =
      TranslationsEditorMenuBoxFitsEn.internal(_root);
  late final TranslationsEditorMenuBgPatternsEn bgPatterns =
      TranslationsEditorMenuBgPatternsEn.internal(_root);
}
...
class TranslationsLoginEncLoginStep$encFaq$0i2$En {
  ...
  String get a =>
      'Yes, but keep in mind that it would be easier for the server administrator or someone else to access your notes if they gain access to your Nextcloud account.';
}
